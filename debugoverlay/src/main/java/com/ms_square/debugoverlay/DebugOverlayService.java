...
public class DebugOverlayService extends Service {
  ...
  public class LocalBinder extends Binder {
    DebugOverlayService getService() {
      // Return this instance of DebugOverlayService so clients can call public
      // methods
  ...
  public void onTaskRemoved(Intent rootIntent) {
    ...
    LocalBroadcastManager.getInstance(getApplicationContext())
        .sendBroadcastSync(new Intent(DebugOverlay.ACTION_UNBIND));
  }
  ...
  public void
  setOverlayViewManager(@NonNull OverlayViewManager overlayViewManager) {
  ...
  public void updateNotification() { showNotification(); }
    ...
    NotificationCompat.Builder builder =
        new NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_ID)
            .setStyle(new NotificationCompat.BigTextStyle().bigText(
                getString(R.string.debugoverlay_notification_big_text)))
            .setSmallIcon(R.drawable.debugoverlay_ic_notification)
            .setLargeIcon(getAppIcon(this))
            .setOngoing(true)
            .setContentTitle(getString(R.string.debugoverlay_notification_title,
                                       getAppName(this), getAppVersion(this)))
            .setContentText(
                getString(R.string.debugoverlay_notification_small_text))
  ...
  private PendingIntent getNotificationIntent(String action) {
    if (action == null) {
      ...
      if (config.getActivityName() != null) {
        try {
          Intent intent =
              new Intent(this, Class.forName(config.getActivityName()));
          pendingIntent = PendingIntent.getActivity(
              this, 0, intent, PendingIntent.FLAG_CANCEL_CURRENT);
        } catch (ClassNotFoundException ne) {
          Log.w(TAG, config.getActivityName() + " was not found - " +
                         ne.getMessage());
        }
      }
  ...
  private static Bitmap getAppIcon(@NonNull Context context) {
    ...
    try {
      drawable = context.getPackageManager().getApplicationIcon(
